...
func (p *MetricsProcessor) RuntimeConfig() map[string]any {
	return map[string]any{"mention_prompt": promptConfig(p.MentionPromptPath, p.MentionPromptRef, p.MentionPromptText),
		...
		"fallback_mention_model":       modelConfig(p.FallbackMentionModelRef, p.FallbackMentionModelCfgPath, p.FallbackMentionModelName, p.FallbackMentionModelCfg),
		"fallback_merge_resolve_model": modelConfig(p.FallbackMergeResolveModelRef, p.FallbackMergeResolveModelCfgPath, p.FallbackMergeResolveModelName, p.FallbackMergeResolveModelCfg),
