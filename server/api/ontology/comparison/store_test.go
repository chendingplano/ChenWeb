...
func TestComparisonStoreCreateScopeRejectsMetricKeyThatIsNotAReleasedMetricDefinitionTerm(t *testing.T) {
	cases := []struct {
		...
		{"wrong term_kind", func() *sqlmock.Rows {
			return sqlmock.NewRows([]string{"id", "term_id", "version", "term_kind", "module_id", "status", "definition", "scope", "source_candidate_id", "properties", "create_time", "create_by", "modify_time", "modify_by"}).
				AddRow(1, "time_to_alarm", 1, "unit", "measurement", "included_in_release", nil, nil, nil, nil, time.Now(), nil, time.Now(), nil)
		}},
		{"not yet released", func() *sqlmock.Rows {
			return sqlmock.NewRows([]string{"id", "term_id", "version", "term_kind", "module_id", "status", "definition", "scope", "source_candidate_id", "properties", "create_time", "create_by", "modify_time", "modify_by"}).
				AddRow(1, "time_to_alarm", 1, "metric_definition", "measurement", "draft", nil, nil, nil, nil, time.Now(), nil, time.Now(), nil)
		}},
	}
...
func TestComparisonStoreValidateMetricKeyAcceptsAutoPromoted(t *testing.T) {
	...
	mock.ExpectQuery(regexp.QuoteMeta("FROM kb.ontology_terms")).WithArgs("measurement:kwc_x").
		WillReturnRows(sqlmock.NewRows([]string{"id", "term_id", "version", "term_kind", "module_id", "status", "definition", "scope", "source_candidate_id", "properties", "create_time", "create_by", "modify_time", "modify_by"}).
			AddRow(1, "measurement:kwc_x", 1, "metric_definition", "measurement", "auto-promoted", nil, nil, nil, nil, time.Now(), nil, time.Now(), nil))
