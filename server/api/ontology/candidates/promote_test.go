...
func TestPromoteToContentMaterializesTerm(t *testing.T) {
	...
	mock.ExpectQuery(regexp.QuoteMeta("INSERT INTO kb.ontology_terms")).
		WithArgs("core:assertion", "class", "core", "approved", "An assertion is a qualified claim.", nil, int64(1), nil, "curator", "curator").
		WillReturnRows(sqlmock.NewRows([]string{
			...
			"An assertion is a qualified claim.", nil, int64(1), nil, now, "curator", now, "curator"))
