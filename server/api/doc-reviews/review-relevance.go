...
func (r *relevanceReviewer) processWindow(
	...
	payload, err := r.client.ExtractJSON(ctx, newLLMJSONInput(ctx, cfg.PromptRef, cfg.PromptText, cfg.ModelName, w.inputJSON, "review_relevance", "MID-CWB-REVIEW-RELEVANCE"))
	if err != nil {
