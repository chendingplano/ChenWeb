-- Persist Phase D health alarms in kb.doc_proc_logs.
-- The in-process high-deferred-candidate warning is an operational error
-- condition and must remain queryable after the process exits.
-- +goose Up
