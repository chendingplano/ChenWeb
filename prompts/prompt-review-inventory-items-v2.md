...
2. **Verify** only the few candidates that plausibly describe the same product and appear to conflict — fetch their source context to check variants and configurations before reporting.
