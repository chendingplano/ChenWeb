import type { TID, IEventBus, IPublicWritable, IEventConfig } from "@wx/lib-state";
...
export type TDispatch = <A extends keyof TMethodsConfig>(action: A, data: TMethodsConfig[A]) => void;
...
export type TEditorHandler = (row?: IRow, column?: IColumn) => TEditorType | IColumnEditor | null;
...
export interface IApi {
    exec: <A extends keyof TMethodsConfig | (string & {})>(action: A, params?: A extends keyof TMethodsConfig ? TMethodsConfig[A] : any) => Promise<any>;
    on: <A extends keyof TMethodsConfig | (string & {})>(action: A, callback: (config: A extends keyof TMethodsConfig ? TMethodsConfig[A] : any) => any, config?: IEventConfig) => void;
    intercept: <A extends keyof TMethodsConfig | (string & {})>(action: A, callback: (config: A extends keyof TMethodsConfig ? TMethodsConfig[A] : any) => any, config?: IEventConfig) => void;
...
export type IExportCell = string | {
    v?: string;
    s?: number;
};
...
export interface IExportOptions {
    ...
    headerCellTemplate?: (value: Value, headerCell: TColumnHeader, column: IColumn, type: TColumnType) => string;
    cellStyle?: (value: Value, row: IRow, column: IColumn) => IDataHash<any> | null;
    headerCellStyle?: (value: Value, headerCell: TColumnHeader, column: IColumn, type: TColumnType) => IDataHash<any> | null;
}
