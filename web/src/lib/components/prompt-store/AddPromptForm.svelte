...
<script lang="ts">
  ...
  let newPrompt = $state<Record<string, any>>({})
  ...
  async function handleSubmit(event : Event) {
    ...
    try {
        ...
        newPrompt.creator_loc = "CWB_APF_078"
        newPrompt.updater_loc = "CWB_APF_078"
    ...
    <div class="form-grid">
      ...
      <div class="form-group">
        ...
        <input
          id="promptName"
          type="text"
          bind:value={newPrompt.prompt_name}
      ...
      <div class="form-group">
        ...
        <textarea
          id="promptDesc"
          bind:value={newPrompt.prompt_desc}
      ...
      <div class="form-group full-width">
        ...
        <textarea
          id="promptContent"
          bind:value={newPrompt.prompt_content}
      ...
      <div class="form-group">
        ...
        <select id="status" bind:value={newPrompt.prompt_status}>
      ...
      <div class="form-group">
        ...
        <input
          id="purpose"
          type="text"
          bind:value={newPrompt.prompt_purpose}
      ...
      <div class="form-group">
        ...
        <select id="source" bind:value={newPrompt.prompt_source}>
      ...
      <div class="form-group">
        ...
        <input
          id="keywords"
          type="text"
          bind:value={newPrompt.prompt_keywords}
      ...
      <div class="form-group">
        ...
        <input
          id="tags"
          type="text"
          bind:value={newPrompt.prompt_tags}
