<script lang="ts">
	...
	let {
		...
		dark = true,
		onclose
	}: { title: string; nodes: JsonTreeNode[]; dark?: boolean; onclose: () => void } = $props();
...
>
	<div
		...
		style="background:{cardBg};border:1px solid {borderColor};width:min(640px,100%);max-height:80vh"
	>
