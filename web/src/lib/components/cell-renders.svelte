...
// The field should be a boolean. If its value is true, it shows 'tick-in-circle', 
// otherwise 'cross-in-circle'
...
// Format Date Cells
// The display format is like: "Monday, Jan 1, 2020"
// The field value can be string
