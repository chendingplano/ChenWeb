<script lang="ts">
	...
	let bg          = $derived(darkMode ? '#171B26' : '#F2F4F7');       // page / card background
...
>
	...
	<div class="px-6 py-6">
		<div class="flex gap-8">
			...
			<div class="flex-shrink-0 w-56">
				...
				<!-- System status -->
				<div class="rounded-lg p-3" style="background:{surface2}; border:1px solid {border};">
	...
	>
		<div class="flex items-center gap-1.5 text-xs" style="color:{textMuted};">
			...
			<span>using</span>
			<span style="color:{accent}; font-family:'Fira Code',monospace;">SvelteKit</span>
			<span>+</span>
		...
		<div class="flex items-center gap-4">
			<span class="text-xs" style="color:{textMuted}; font-family:'Fira Code',monospace;">v4.0.0-rc1</span>
			<a
