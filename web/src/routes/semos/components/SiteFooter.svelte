...
<footer class="relative bg-[#f3f1ec] dark:bg-[#15181e]">
	...
	<div class="mx-auto max-w-7xl px-6 py-14 md:py-16">
		<div class="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
			...
			<div>
				<h3 class="text-xs font-bold tracking-[0.18em] uppercase text-[#b08d57]">
					Quick Links
				</h3>
				<ul class="mt-6 space-y-3">
					{#each quickLinks as link (link.label)}
						<li>
							<a
								href={link.href}
								class="group inline-flex items-center gap-1.5 text-sm text-[#17181c]/70 transition-colors duration-200 hover:text-[#17181c] dark:text-white/70 dark:hover:text-white"
							>
								{link.label}
			...
			<div>
				...
				<div class="mt-5 flex gap-3">
					<a href="/semos" class="flex h-9 w-9 items-center justify-center rounded-full bg-[#17181c]/6 text-[#17181c]/50 shadow-[inset_0_1px_1px_rgba(255,255,255,0.8),0_1px_3px_rgba(23,24,28,0.08)] transition-all duration-200 hover:bg-[#b08d57]/15 hover:text-[#b08d57] dark:bg-white/8 dark:text-white/50 dark:shadow-none dark:hover:bg-[#b08d57]/20" aria-label="LinkedIn">
						<svg class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 0 1-2.063-2.065 2.064 2.064 0 1 1 2.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
					</a>
					<a href="/semos" class="flex h-9 w-9 items-center justify-center rounded-full bg-[#17181c]/6 text-[#17181c]/50 shadow-[inset_0_1px_1px_rgba(255,255,255,0.8),0_1px_3px_rgba(23,24,28,0.08)] transition-all duration-200 hover:bg-[#b08d57]/15 hover:text-[#b08d57] dark:bg-white/8 dark:text-white/50 dark:shadow-none dark:hover:bg-[#b08d57]/20" aria-label="Twitter / X">
						<svg class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
					</a>
					<a href="/semos" class="flex h-9 w-9 items-center justify-center rounded-full bg-[#17181c]/6 text-[#17181c]/50 shadow-[inset_0_1px_1px_rgba(255,255,255,0.8),0_1px_3px_rgba(23,24,28,0.08)] transition-all duration-200 hover:bg-[#b08d57]/15 hover:text-[#b08d57] dark:bg-white/8 dark:text-white/50 dark:shadow-none dark:hover:bg-[#b08d57]/20" aria-label="GitHub">
	...
	<!-- Copyright bar -->
	<div class="border-t border-[#17181c]/8 dark:border-white/8">
		<div class="mx-auto flex max-w-7xl flex-col items-center justify-between gap-2 px-6 py-6 text-xs text-[#6f6c66] md:flex-row dark:text-white/35">
