...
<style>
	...
	@media (max-width: 700px) { .topbar { padding: 0 18px; }.content { padding: 25px 18px 24px; }.title-row h1 { font-size: 30px; }.title-actions { width: 100%; }.title-actions button { flex: 1; justify-content: center; }.mode-tabs { overflow-x: auto; white-space: nowrap; }.coverage-notice { align-items: start; }.notice-detail { margin-left: auto; }.notice-expanded { padding-left: 0; flex-direction: column; gap: 7px; }.scope-bar { overflow-x: auto; white-space: nowrap; }.scope-label { flex: 0 0 auto; }.scope-select, .scope-chip { flex: 0 0 auto; }.reset-button { margin-left: 0; }.kpi-grid { grid-template-columns: repeat(2, 1fr); }.kpi { min-height: 118px; padding: 14px 12px; }.kpi strong { font-size: 23px; margin: 21px 0 13px; }.error-visual { align-items: start; flex-direction: column; }.donut { width: 132px; height: 132px; }.donut::before { width: 96px; height: 96px; }.section-heading { align-items: start; flex-direction: column; }.table-tools { width: 100%; }.search-field { flex: 1; }.search-field input { width: 100%; }.page-footer { align-items: start; flex-direction: column; }.page-footer span:last-child { flex-wrap: wrap; } }
