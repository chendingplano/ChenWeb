...
<style>
	...
	.empty-state { padding: 24px 0; color: var(--subtle); font: 500 10px 'DM Mono', monospace; text-align: center; }.empty-state-panel { min-height: 140px; display: grid; place-items: center; border: 1px dashed var(--border); background: color-mix(in oklch, var(--surface) 84%, var(--bronze) 16%); }
