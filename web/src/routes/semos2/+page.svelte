...
<section class="relative overflow-hidden">
	...
	<div class="relative mx-auto max-w-7xl px-6 py-28 md:py-36 lg:py-44">
		<div use:reveal class="reveal max-w-2xl">
			...
			<!-- Stacked headline -->
			<h1 class="mt-7 text-[clamp(2.6rem,4.5vw+1rem,4.5rem)] font-bold leading-[1.08] tracking-tight text-[#17181c] dark:text-[#e9e7e2]">
				{#each sloganLines as line (line)}
					<span class="block">{line}</span>
				{/each}
			</h1>

			<p class="mt-7 max-w-[52ch] text-base leading-relaxed text-[#6f6c66] md:text-lg dark:text-[#a5a29b]">
				{cfg.hero.subtitle}
			</p>
			...
			<div class="mt-10 flex flex-wrap items-center gap-4">
				...
				<a
					...
					class="group inline-flex items-center gap-2 rounded-lg border border-[#17181c]/15 bg-white/70 px-7 py-3.5 text-sm font-semibold text-[#17181c] shadow-[0_1px_2px_rgba(23,24,28,0.06),0_4px_12px_rgba(23,24,28,0.06)] backdrop-blur-sm transition-all duration-200 hover:-translate-y-0.5 hover:border-[#17181c]/30 hover:shadow-[0_2px_4px_rgba(23,24,28,0.08),0_8px_20px_rgba(23,24,28,0.1)] active:translate-y-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#17181c]/30 dark:border-white/20 dark:bg-white/10 dark:text-white"
				>
					{m.semos_signup_login()}
					<ArrowDown class="h-3.5 w-3.5 opacity-50 transition-transform duration-200 group-hover:translate-y-0.5" />
				</a>
			</div>
		</div>
	</div>
	...
	<div class="mx-auto max-w-7xl px-6 pt-20 pb-8 md:pt-28">
		{#each cfg.highlights as h, i (h.title)}
			...
			>
				<!-- Text -->
				<div>
					<span class="text-xs font-bold tracking-[0.22em] uppercase text-[#b08d57]">
						{String(i + 1).padStart(2, '0')}
					</span>
					<h2 class="mt-4 text-2xl font-bold leading-snug tracking-tight text-[#17181c] md:text-[2rem] md:leading-tight dark:text-[#e9e7e2]">
						{h.title}
					</h2>
				...
				<div class="group relative">
					...
					<div class="absolute inset-x-8 -bottom-4 h-8 rounded-[50%] bg-[#17181c]/10 blur-xl transition-all duration-500 group-hover:inset-x-6 group-hover:bg-[#17181c]/14 dark:bg-black/40"></div>
					<div
						class="relative overflow-hidden rounded-xl border-t border-white bg-white p-2.5 shadow-[0_1px_2px_rgba(23,24,28,0.08),0_12px_32px_rgba(23,24,28,0.14)] transition-all duration-500 {i % 2 === 1 ? 'rotate-[0.75deg]' : 'rotate-[-0.75deg]'} group-hover:rotate-0 group-hover:shadow-[0_2px_4px_rgba(23,24,28,0.1),0_20px_48px_rgba(23,24,28,0.18)] dark:border-white/10 dark:bg-[#1a1d24]"
					>
						<img
							src={h.image}
							alt={h.title}
		...
		<div class="mt-14 grid gap-7 sm:grid-cols-2 lg:grid-cols-4">
			{#each cfg.features as f, i (f.key)}
				...
				>
					...
					<div class="inline-flex w-fit rounded-full bg-gradient-to-b from-[#f6f4ef] to-[#e9e5dc] p-3.5 text-[#b08d57] shadow-[inset_0_1px_1px_rgba(255,255,255,0.9),0_2px_6px_rgba(23,24,28,0.12)] transition-transform duration-300 group-hover:scale-105 dark:from-[#252a35] dark:to-[#1c2029] dark:shadow-[inset_0_1px_1px_rgba(255,255,255,0.08),0_2px_6px_rgba(0,0,0,0.5)]">
						<Icon class="h-6 w-6" />
					</div>
					<div class="mt-6 flex items-start justify-between gap-2">
						...
						<ArrowUpRight class="mt-0.5 h-4 w-4 shrink-0 text-[#b08d57]/0 transition-all duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 group-hover:text-[#b08d57]" />
					</div>
